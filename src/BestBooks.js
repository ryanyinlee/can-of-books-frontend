...
try{
  ...
  const userBooks = await axios.post(`${process.env.REACT_APP_SERVER_URL}/books`, newBook);
  // console.log(newBook);
...
handleSubmit = (event) => {
  ...
  console.log("handleSubmit gives us newbook object: " + JSON.stringify(newBook))
                ...
                <Carousel.Item>
                  {/* <Carousel.Caption>  */}
                    ...
                    <li key={oneBook._id}>
                      ...
                      <span> <Button onClick = {() => this.deleteBook(oneBook._id, oneBook.email)}>Delete</Button></span>
...
{(this.props.user && this.state.showModal) ? <BookForModal handleSubmit ={this.handleSubmit} makeBook ={this.makeBook} showModal = {this.state.showModal} closeModal = {this.closeModal} /> : <> <Button onClick = {this.handleClick}> Add A Book</Button></> }

{/* {(this.props.user && this.state.showModal) ? <UpdateBookModal updateBook ={this.updateBook} book={this.state.books} showModal = {this.state.showModal} closeModal = {this.closeModal} /> :
